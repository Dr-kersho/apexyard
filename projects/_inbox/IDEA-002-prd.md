...
| Should the couple layer be a separate subscription tier or bundled? | Head of Product | Open | To be decided at pricing review |
| What is the minimum viable couple-layer feature for V1 — full biological cycle logging or just a daily mood check-in? | Product | Open | Recommendation: daily mood check-in (3-tap) only in V1; cycle logging in V1.1 |
| COPPA + GDPR legal review — who owns this and what is the timeline? | Head of Product / Legal | Open | Must be resolved before beta |
